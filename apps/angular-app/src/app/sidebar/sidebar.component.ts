...
export class Sidebar implements AfterContentInit, OnInit, OnChanges, OnDestroy {
  ...
  @Input() autoCollapseHeight: number | undefined;
  @Input() autoCollapseWidth: number | undefined;
  @Input() autoCollapseOnInit: boolean = true;

  @Input() sidebarClass: string | undefined;
  ...
  private _onClickOutside(e: Event): void {
    if (this._onClickOutsideAttached && this._elSidebar && !this._elSidebar.nativeElement.contains((e as MouseEvent).target)) {
      this.close();
    }
  }
